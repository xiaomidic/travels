...
import day02.l.example.com.everywheretrip.trip.util.SystemUtil;
...
public class PreviewIndicator extends LinearLayout {
    ...
    public void initSize(int chosedSize,int nomal,int hei) {
        chooseSize = SystemUtil.dp2px(chosedSize);
        nomalSize = SystemUtil.dp2px(nomal);
        height = SystemUtil.dp2px(hei);
    }
